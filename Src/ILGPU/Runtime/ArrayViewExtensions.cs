...
public static partial class ArrayViewExtensions
{
        ...
        where TView : IArrayView
    {
        ...
        return parentBuffer is null || parentBuffer.Accelerator is null
    ...
    public static unsafe ArraySegment<byte> GetRawData<TView>(
        ...
        where TView : IContiguousArrayView
    {
        var rawOffset = Interop.Align(byteOffset, view.ElementSize);
        var rawExtent = Interop.Align(byteExtent, view.ElementSize);
